...
setEmail("")
  ...
  return (
    <div className='flex justify-center m-10'>
        <div className='md:p-10 p-2 border-2 border-gray-200 rounded-md shadow-md shadow-black'>
          <div className='mt-5 md:ml-0 ml-10'>
             <p className='md:text-4xl text-2xl'>Forget Your Password ?</p>
            </div> 

            <div className='md:mt-20 mt-10 md:ml-0 ml-10'>
            ...
            <div className='flex justify-center mt-5'>
                <p>Dont have an account ? <span className='text-blue-600'><Link to="/signup">Sing U</Link>p</span></p>
            </div>
        </div>
        <ToastContainer/>
    </div>
