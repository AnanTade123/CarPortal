...
function NavListMenu() {
    ...
    <>
      ...
      <Link to={"/dealer/live/cars"}>
        ...
        <Typography
          ...
          className={`p-3 rounded-md font-normal ${window.location.pathname === "/dealer/live/cars" ? "bg-indigo-200 text-white" : ""}`}
  ...
  const navList = (
    ...
    <ul className="mt-2 mb-4 flex flex-col gap-2 p-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      {userRole == "DEALER" || userRole == "INSPECTOR" || userRole == "SALESPERSON" ? null : (
        <Link to={"/carlist"}>
          <Typography
            as="li"
            variant="small"
