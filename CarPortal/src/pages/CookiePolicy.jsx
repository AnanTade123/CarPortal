    ...
    <div className="max-w-screen-3xl mx-auto bg-light-blue-50">
      ...
      <div className="mx-4 my-6 md:ml-20 md:mr-12 lg:ml-36 lg:mr-24">
        ...
        <p className="mt-8 text-lg">
          ...
          practices. That’s why we have tried to keep legal and technical jargon
          to a minimum.
        </p>
        ...
        <p className="mt-8 text-lg">
          ...
          contain a unique identifier that enable us to recognise when someone
          has visited our service or opened an email that we have sent them.
          Tracking URLs are custom generated links that help us understand where
          the traffic to our web pages comes from. SDKs are small pieces of code
        ...
        <p className="mt-8 text-lg mb-3">
          ...
          website is being used, how effective marketing campaigns are, and help
          us customize and improve our websites for you.
        </p>
        <hr />
        <p className="flex text-lg mt-8 mb-3">
          <b>Advertising cookies: </b> These cookies are used to make
          ...
          ads are properly displayed for advertisers,selecting advertisements
          that are based on your interests and measuring the number of ads
          displayed and their performance, such as how many people clicked on a
          given ad.
        </p>
        <hr />
        <p className="flex text-lg mt-8 mb-3">
          <b>Social networking cookies: </b> These cookies are used to enable
        ...
        <p className="mt-8 text-lg">
          ...
          browsing our website a less satisfying experience. In some cases, you
          may even find yourself unable to use all or part of our site.
        </p>
        <p className="mt-8 text-xl">
        ...
        <p className="mt-4 text-lg">
          ...
          device identifiers is slightly different for each device. You can
          check the specific steps in the help or settings menu of your
          particular device.
        </p>
        <p className="mt-8 text-xl">
          <b>Interest-based advertising tools</b>
        </p>
        <p className="mt-2 text-lg">
        ...
        <p className="mt-6 text-lg">
          ...
          or LinkedIn™ “in” buttons or Facebook). Depending on your social media
          account settings, we automatically receive information from the social
          media platform when you use the corresponding button on our website.
        </p>
        <p className="mt-4 text-lg">
        ...
        <p className="mt-6 text-lg">
          ...
          manages this information and your choices via an interface separate
          from that supplied by your browser.
        </p>
        <p className="mt-4 text-lg">
        ...
        <p className="mt-4 text-lg">
          <b>
            Stuff Google Wants to Make Sure You Know about Google’s Data
        ...
        <p className="mt-4 text-lg">
          ...
          cookies on your device and to the access, usage and sharing by Google
          of the data collected thereby.
        </p>
        <p className="mt-4 text-lg">
          Google™ manages the information and your choices pertaining to Google™
          Maps API Cookies via an interface separate from that supplied by your
