  ...
  <a href="#" className="relative inline-block w-full transform transition-transform duration-300 ease-in-out hover:-translate-y-2">
    <div className="rounded-lg bg-white   shadow-md border">
      ...
      <div className="flex md:space-x-1 space-x-1 mt-3">
        <div className="p-2 text-[10px] bg-gray-100 rounded-md">40,000 km</div>
        <div className="p-2 text-[10px] bg-gray-100 rounded-md">1st owner</div>
        <div className="p-2 text-[10px] bg-gray-100 rounded-md">Petrol</div>
        <div className="p-2 text-[10px] bg-gray-100 rounded-md">MH-12</div>
