...
import FilterPremiumCars from "../components/buyCar/FilterPremiumCars";
import GridPremiumCarList from "../components/buyCar/GridPremiumCarList";
        ...
        <div className="grid grid-cols-1 gap-2 md:grid-cols-5 lg:grid-cols-4 lg:gap-6">
          ...
          <div className="md:col-span-3 lg:col-span-3 no-scrollbar">
            {error?.status === 404 ? (
              ...
              <GridPremiumCarList data={data} error={error} refetch={refetch} />
            )}
          </div>
        </div>
      </div>
