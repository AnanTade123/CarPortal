...
const Electrical = () => {
  ...
  const { id } = useParams();
  console.log(id);
  const { data } = useGetInspectionReportQuery({ id, docType: "Electrical" });
  console.log(data);
...
console.log(lables)
  ...
  const handleFileChange = async (event, fieldName) => {
    ...
    reader.onload = async () => {
      ...
      setImages({ ...images, [fieldName]: imageData });
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div className="flex items-center mt-2">
            <input
              accept="image/*"
              style={{ display: 'none' }}
              id="upload-FourPowerWindowss"
              type="file"
              onChange={(event) => handleFileChange(event, 'FourPowerWindowss')}
            />
            <label htmlFor="upload-FourPowerWindowss" className="cursor-pointer flex items-center">
              <CloudUploadIcon />
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div className="flex items-center mt-2">
            <input
              accept="image/*"
              style={{ display: 'none' }}
              id="upload-AirBagFeaturess"
              type="file"
              onChange={(event) => handleFileChange(event, 'AirBagFeaturess')}
            />
            <label htmlFor="upload-AirBagFeaturess" className="cursor-pointer flex items-center">
              <CloudUploadIcon />
              <span className="ml-2">Upload Image</span>
            </label>
          </div>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div className="flex items-center mt-2">
            <input
              accept="image/*"
              style={{ display: 'none' }}
              id="upload-MusicSystems"
              type="file"
              onChange={(event) => handleFileChange(event, 'MusicSystems')}
            />
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div className="flex items-center mt-2">
            <input
              ...
              id="upload-Sunroofs"
              type="file"
              onChange={(event) => handleFileChange(event, 'Sunroofs')}
            />
            <label htmlFor="upload-Sunroofs" className="cursor-pointer flex items-center">
              <CloudUploadIcon />
              <span className="ml-2">Upload Image</span>
            </label>
          </div>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div className="flex items-center mt-2">
            <input
              ...
              id="upload-ABSs"
              type="file"
              onChange={(event) => handleFileChange(event, 'ABSs')}
            />
            <label htmlFor="upload-ABSs" className="cursor-pointer flex items-center">
              <CloudUploadIcon />
              <span className="ml-2">Upload Image</span>
            </label>
          </div>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div className="flex items-center mt-2">
            <input
              accept="image/*"
              style={{ display: 'none' }}
              id="upload-InteriorParkingSensors"
              type="file"
              onChange={(event) => handleFileChange(event, 'InteriorParkingSensors')}
            />
            <label htmlFor="upload-InteriorParkingSensors" className="cursor-pointer flex items-center">
              <CloudUploadIcon />
              <span className="ml-2">Upload Image</span>
            </label>
          </div>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <div className="flex items-center mt-2">
            <input
              accept="image/*"
              style={{ display: 'none' }}
              id="upload-Electricalwirings"
              type="file"
              onChange={(event) => handleFileChange(event, 'Electricalwirings')}
            />
            <label htmlFor="upload-Electricalwirings" className="cursor-pointer flex items-center">
              <CloudUploadIcon />
              <span className="ml-2">Upload Image</span>
            </label>
          </div>
