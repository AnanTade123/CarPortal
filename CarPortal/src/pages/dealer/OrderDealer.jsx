...
const OrderDealer = () => {
  ...
  const renderData = data?.bookings?.map((item, index) => {
    return (
      <div className="ml-8 mt-5" key={index}>
        <CardUi>
          <div>
            <p>
            ...
            <p>
              Price:<span className="font-semibold text-lg">{item?.price}</span>
            </p>
  ...
  return (
    <>
      <div className="grid grid-cols-4 auto-cols-auto auto-rows-auto">
        {renderData}
      </div>
